# This code is used to insert an element into a sorted linked list
...
# Defining a function to search for a value in a linked list
...
# Creating a few node to make a linked list
head = ListNode(1)
second = ListNode(3)
third = ListNode(4)

# Connecting these nodes to form a linked list
head.next = second
second.next = third
