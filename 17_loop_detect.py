# This code is to detect a loop in a linked list
# Defining the class ListNode
class ListNode:
...
# Defining a function to delete a node at a given position from the linked list
...
# Defining a function to search for an element in a linked list
...
# Defining a function to detect a loop in a linked list
...
# Printing a looped linked list makes an infinite loop

# Checking for the loop in this linked list
